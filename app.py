    ...
    try:
        ...
        while capture_running:
            try:
                ...
                print(f"Active connections captured: {len(packet_logs)}")
            except Exception as inner_e:
                print(f"Error during sniffing: {inner_e}")
                time.sleep(0.5)

    except Exception as e:
        print(f"Critical error in capture thread: {e}")
...
class NetworkCaptureAPI:
    ...
    def get_status(self):
        ...
        print(f"Status check: Capture running = {capture_running}, Log count = {len(packet_logs)}")
...
class NetworkProcessMapper:
    ...
    def start(self):
        print("Starting Network Process Mapper...")
    ...
    def get_html_content(self):
        try:
            ...
            print("ERROR: app.html file not found. Make sure it exists in the same directory as this script.")
            raise
        except Exception as e:
